...
export class ReferenceDecorationProvider {
    ...
    activate(context) {
        ...
        context.subscriptions.push(
            ...
            vscode.workspace.onDidChangeTextDocument(
                (event) => this.scheduleRefresh(event.document)
            ),
    ...
    applyConfiguration() {
        ...
        this._validDecoration =
            vscode.window.createTextEditorDecorationType({
                color: linkColorValue(configuration.linkColor),
                textDecoration: configuration.linkUnderline
                    ? "underline"
                    : undefined
            });

        this._errorDecoration =
            vscode.window.createTextEditorDecorationType({
    ...
    refresh() {
        ...
        for (const { reference, line } of
            scanDocumentForReferences(editor.document)) {
