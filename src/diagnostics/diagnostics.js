...
import { collectBrokenReferences } from "./brokenReferenceScanner.js";
...
export class DiagnosticsManager {
   ...
   */
  update(document) {
    if (!supportsLanguage(document.languageId) || !getConfiguration().enableDiagnostics) {
    ...
    const broken = collectBrokenReferences(
      ...
      workspaceRelativePath(document.uri.fsPath, workspaceFolder),
    );
